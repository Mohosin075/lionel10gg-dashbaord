      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Manage languages and translation files
          </p>
        </div>
        <Button
            ...
            {data.map((item) => (
              <TableRow key={item.id} className="hover:bg-slate-50">
                ...
                <TableCell>
                  <Badge
                    variant="outline"
                    className="font-normal text-slate-600 border-slate-200 bg-white"
                  >
                    {item.direction}
                  </Badge>
                </TableCell>
      ...
      <div className="rounded-xl border border-blue-100 bg-blue-50/50 p-6 flex gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            Use the "Upload Translations" button to add or update translation
            files for each language. Supported formats include JSON and CSV.
            Each translation file should contain all 6,236 verses of the Quran
              ...
              <div className="flex items-center justify-between mt-2 p-4 rounded-xl bg-slate-50 border border-transparent">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-slate-500">
                    Make this language available in the app
                  </p>
                </div>
                <Switch
                  checked={statusValue}
