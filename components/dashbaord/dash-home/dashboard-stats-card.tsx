...
// export default function DashboardStatsCard(stats: any) {
//     console.log(stats)
...
//                         <CardTitle className="text-sm font-medium text-slate-500">{data.title}</CardTitle>
//                         {data.icon}
//                     </CardHeader>
//                     <CardContent>
//                         <div className="text-2xl font-bold">{data.value}</div>
//                         <p className={`text-xs ${data.isPositive ? 'text-emerald-500' : 'text-red-500'} flex items-center gap-1 mt-1`}>
