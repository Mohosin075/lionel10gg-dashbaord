...
export default function OtpVerify() {
  ...
  return (
    <div className="w-full rounded-lg bg-white md:px-8 py-10 ">
      <h1 className="text-3xl font-semibold text-gray-900">OTP Verify</h1>
      ...
      <div className="flex justify-end">
        {countdown > 0 ? (
          <p className="text-base text-gray-600">Resend in {countdown}s</p>
        ) : (
          <div className="flex items-center gap-1">
            <p className="text-base text-gray-600">Don&apos;t receive any code?</p>
            <Button
